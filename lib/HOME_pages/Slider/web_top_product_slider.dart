...
class web_top_product_slider extends StatefulWidget {
  const web_top_product_slider({Key? key}) : super(key: key);

  @override
  State<web_top_product_slider> createState() => _web_top_product_sliderState();
}

class _web_top_product_sliderState extends State<web_top_product_slider> {
